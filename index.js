...
conn.sendMessage(id, ' _TERIMAKASIH BANYAK TELAH MENGGUNAKAN FITUR INI...UNTUK PEMBUATAN BOT INI CEK CHANEL FYRUS TINGGALKAN SUBSCRIBE YHA' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾_XONTOL-BOT_👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@IndraFajri64' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾_XONTOL-BOT_👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@IndraFajri64' ,MessageType.text);
}
